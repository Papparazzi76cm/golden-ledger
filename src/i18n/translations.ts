...
export const translations: Record<Language, Translations> = {
  ...
  en: {
    ...
    blog: {
      ...
      readTime: 'min read',
      subtitle: 'Guides, analysis and news about gold investment',
      featured: 'Featured',
      ...
      linkCopiedDesc: 'The article link has been copied to clipboard.',
      articleSaved: 'Article saved',
      articleSavedDesc: 'The article has been saved to your favorites.',
      tags: 'Tags',
      wasUseful: 'Was this article useful?',
  ...
  fr: {
    ...
    blog: {
      ...
      subtitle: "Guides, analyses et actualités sur l'investissement en or",
      featured: 'À la une',
      ...
      linkCopiedDesc: "Le lien de l'article a été copié dans le presse-papiers.",
      articleSaved: 'Article sauvegardé',
      articleSavedDesc: "L'article a été ajouté à vos favoris.",
      tags: 'Tags',
      wasUseful: 'Cet article vous a-t-il été utile ?',
  ...
  de: {
    ...
    blog: {
      ...
      subtitle: 'Leitfäden, Analysen und Neuigkeiten über Goldinvestitionen',
      featured: 'Empfohlen',
      readArticle: 'Artikel lesen',
      latestArticles: 'Neueste Artikel',
      articleNotFound: 'Artikel nicht gefunden',
      articleNotFoundDesc: 'Der gesuchte Artikel existiert nicht.',
      backToBlog: 'Zurück zum Blog',
      linkCopied: 'Link kopiert',
      linkCopiedDesc: 'Der Artikellink wurde in die Zwischenablage kopiert.',
      articleSaved: 'Artikel gespeichert',
      articleSavedDesc: 'Der Artikel wurde zu Ihren Favoriten hinzugefügt.',
      tags: 'Tags',
      wasUseful: 'War dieser Artikel hilfreich?',
