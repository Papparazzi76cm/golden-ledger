  ...
  "rounded-lg text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        gold: "bg-card border border-gold/20 hover:border-gold/40 shadow-gold",
        premium: "bg-charcoal-light border border-gold/10 hover:border-gold/30 shadow-elegant hover:shadow-gold",
